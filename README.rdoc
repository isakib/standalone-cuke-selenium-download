...
Travis build status! 
{<img src="https://travis-ci.org/sivajankan/standalone-cuke-selenium-download.png?branch=master" alt="Build Status" />}[https://travis-ci.org/sivajankan/standalone-cuke-selenium-download] 

 As growing interest in BDD and continous integration, standalone cucumbers became good start for 
 making test suite for non rails projects too. 
 
 This repo contains additional setups for selenium (click and) download and more 
 step_definitions to accommodate
...
== References
 ...
 Download module is modified from the original version available 
 in https://github.com/ninjapanzer/cuke-capy-chrome
...
* support/javascript.rb : javascript triggers and ajax request completion check (requires jQuery)
